...
export const metadata: Metadata = {
  ...
  description: "Pick a time for a 15-minute call. Tell me about your business and I'll build your landing page concept.",
...
export default function FreeLandingPageBookingPage() {
  return (
    <>
      ...
      <main className="mx-auto max-w-[1100px] px-5 pb-16 pt-10 sm:px-10 sm:pt-14">
        <Reveal className="mx-auto max-w-[720px] text-center">
          <h1 className="text-[clamp(28px,3.6vw,44px)] font-medium leading-[1.05] tracking-[-0.04em]">
            Pick a time and I&rsquo;ll build your landing page.
          </h1>
