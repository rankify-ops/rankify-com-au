  ...
  blocks: [
    ...
    },
    {
      ...
      rows: [
        ...
        { icon: "shield", label: "Hosting & security", agency: "Up to $600/yr, ongoing", us: "We host & secure it, $250/yr" },
        { icon: "card", label: "Ongoing cost / year", agency: "$2,000 – $7,000+", us: "$250 hosting, nothing else", highlight: true },
      ],
      footnote: "Agency retainers add up every single year. With me it's $250 a year for hosting and security, and nothing else unless you ask for it.",
    ...
    },
    {
      ...
      items: [
        ...
        { idx: "05", title: "Launch", image: "/assets/images/jeJzliriilgkAa6aYwiNxC60o.webp", desc: "We handle the domain, the DNS and going live. Your site is custom coded, so there's no page builder for you to wrestle with — send us changes any time and we make them, twice a month, at no charge. Live in 7–14 days from sign-off, hosted and secured for $250 a year." },
